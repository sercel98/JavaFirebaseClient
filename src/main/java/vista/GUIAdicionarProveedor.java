 ...
 * @author PAOLA
 */
public class GUIAdicionarProveedor extends javax.swing.JFrame {

    private ServicioDulce servicio;    

    /**
     * Creates new form GUIAdicionarProveedor
     */
    public GUIAdicionarProveedor() {
        initComponents();
    ...
    private void txtAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAgregarActionPerformed
        // TODO add your handling code here:
        if(txtIdentificador.getText().equals("") || txtNombre.getText().equals("") || txtDireccion.getText().equals("")  )
       {
       ...
       else
       {
        ...
        JOptionPane.showMessageDialog(this, "Proveedor agregado exitosamente", "Aviso", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIAdicionarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIAdicionarProveedor().setVisible(true);
            }
        });
    }
